                    ...
                    <ul class="nav" id="side-menu">
                        <li >
							<center>
								...
								<img src="{{ URL::asset('assets/img/default.png')}}" class="img-circle img-responsive" style="border:1px solid red; height:100px;width:100px;"  />							
								<h4>User : {{$user[0]->fname}}</br> <small>Role : {{$user[0]->role}}</small></h4>
							</br>
							</center>
						</li>
                        <li>
